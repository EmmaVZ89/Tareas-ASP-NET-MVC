...
namespace TareasMVP.Controllers
{
    ...
    public class ArchivosController : ControllerBase
    {
        ...
        public ArchivosController(ApplicationDbContext context, IAlmacenadorArchivos almacenadorArchivos,
            ...
            [FromForm] IEnumerable<IFormFile> archivos)
        {
            ...
            var existenArchivosAdjuntos =
                await context.ArchivoAdjuntos.AnyAsync(a => a.TareaId == tareaId);
